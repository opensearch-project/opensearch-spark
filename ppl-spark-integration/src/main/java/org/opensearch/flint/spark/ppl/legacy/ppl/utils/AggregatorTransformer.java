...
public interface AggregatorTransformer {
    ...
    static Expression aggregator(org.opensearch.flint.spark.ppl.legacy.ast.expression.AggregateFunction aggregateFunction, Expression arg) {
    ...
    private static double getPercentDoubleValue(AggregateFunction aggregateFunction) {
        ...
        org.opensearch.flint.spark.ppl.legacy.ast.expression.Literal percentIntValue = ((Argument) aggregateFunction.getArgList().get(0)).getValue();
