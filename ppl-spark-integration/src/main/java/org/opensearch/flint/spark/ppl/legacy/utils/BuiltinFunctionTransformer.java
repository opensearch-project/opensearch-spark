...
import org.opensearch.flint.spark.ppl.legacy.ast.expression.IntervalUnit;
...
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.ADD;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.ADDDATE;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.APPROX_COUNT_DISTINCT;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.ARRAY_LENGTH;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.CIDR;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.DATEDIFF;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.DATE_ADD;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.DATE_SUB;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.DAY_OF_MONTH;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.COALESCE;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.EARLIEST;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.IP_TO_INT;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.IS_BLANK;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.IS_EMPTY;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.IS_IPV4;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.JSON;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.JSON_APPEND;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.JSON_ARRAY;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.JSON_ARRAY_LENGTH;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.JSON_DELETE;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.JSON_EXTEND;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.JSON_EXTRACT;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.JSON_KEYS;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.JSON_OBJECT;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.JSON_SET;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.JSON_VALID;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.LATEST;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.SUBTRACT;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.MULTIPLY;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.DIVIDE;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.MODULUS;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.DAY_OF_WEEK;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.DAY_OF_YEAR;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.HOUR_OF_DAY;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.IS_NOT_NULL;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.IS_NULL;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.LENGTH;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.LOCALTIME;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.MINUTE_OF_HOUR;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.MONTH_OF_YEAR;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.RELATIVE_TIMESTAMP;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.SECOND_OF_MINUTE;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.SUBDATE;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.SYSDATE;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.TIMESTAMPADD;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.TIMESTAMPDIFF;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.TO_JSON_STRING;
import static org.opensearch.flint.spark.ppl.legacy.expression.function.BuiltinFunctionName.TRIM;
...
public interface BuiltinFunctionTransformer {
  ...
  Map<BuiltinFunctionName, Function<List<Expression>, Expression>> PPL_TO_SPARK_UDF_MAPPING
    ...
    static Expression builtinFunction(org.opensearch.flint.spark.ppl.legacy.ast.expression.Function function, List<Expression> args) {
