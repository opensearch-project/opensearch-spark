...
class PPLLogicalPlanFieldSummaryCommandTranslatorTestSuite
  ...
  test("test fieldsummary with single field includefields(id, status_code, request_path) & nulls=true") {
    ...
    val aggregateIdPlan = Aggregate(
      Seq(Alias(UnresolvedFunction("TYPEOF", Seq(UnresolvedAttribute("id")), isDistinct = false), "TYPEOF(id)")()),
      Seq(
        Alias(Literal("id"), "Field")(),
        Alias(UnresolvedFunction("COUNT", Seq(UnresolvedAttribute("id")), isDistinct = false), "COUNT(id)")(),
        Alias(UnresolvedFunction("COUNT", Seq(UnresolvedAttribute("id")), isDistinct = true), "COUNT_DISTINCT(id)")(),
        Alias(UnresolvedFunction("MIN", Seq(UnresolvedAttribute("id")), isDistinct = false), "MIN(id)")(),
        Alias(UnresolvedFunction("MAX", Seq(UnresolvedAttribute("id")), isDistinct = false), "MAX(id)")(),
        Alias(UnresolvedFunction("AVG", Seq(UnresolvedAttribute("id")), isDistinct = false), "AVG(id)")(),
        Alias(UnresolvedFunction("TYPEOF", Seq(UnresolvedAttribute("id")), isDistinct = false), "TYPEOF(id)")()
      ),
      table
    )
    ...
    // Define the aggregate plan with alias for TYPEOF in the aggregation
    val aggregatePlan = Aggregate(
      Seq(Alias(UnresolvedFunction("TYPEOF", Seq(UnresolvedAttribute("request_path")), isDistinct = false), "TYPEOF(request_path)")()),
      Seq(
        Alias(Literal("request_path"), "Field")(),
        Alias(UnresolvedFunction("COUNT", Seq(UnresolvedAttribute("request_path")), isDistinct = false), "COUNT(request_path)")(),
        Alias(UnresolvedFunction("COUNT", Seq(UnresolvedAttribute("request_path")), isDistinct = true), "COUNT_DISTINCT(request_path)")(),
        Alias(UnresolvedFunction("MIN", Seq(UnresolvedAttribute("request_path")), isDistinct = false), "MIN(request_path)")(),
        Alias(UnresolvedFunction("MAX", Seq(UnresolvedAttribute("request_path")), isDistinct = false), "MAX(request_path)")(),
        Alias(UnresolvedFunction("AVG", Seq(UnresolvedAttribute("request_path")), isDistinct = false), "AVG(request_path)")(),
        Alias(UnresolvedFunction("TYPEOF", Seq(UnresolvedAttribute("request_path")), isDistinct = false), "TYPEOF(request_path)")()
      ),
      table
    )
