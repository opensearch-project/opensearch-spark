...
lazy val opensearchClientVersion = "2.6.0"
lazy val opensearchVersion = "2.9.0.0"
...
lazy val flintCore = (project in file("flint-core"))
  ...
  .settings(
    ...
    libraryDependencies ++= osDeps(opensearchVersion, opensearchClientVersion),
    publish / skip := true)
...
lazy val flintSparkIntegration = (project in file("flint-spark-integration"))
  ...
  .settings(
    ...
    libraryDependencies ++= sparkDeps(sparkVersion),
    libraryDependencies ++= osDeps(opensearchVersion, opensearchClientVersion),
    // ANTLR settings
