...
```
bin/spark-shell --packages "org.opensearch:opensearch-spark-ppl_2.12:0.8.0-SNAPSHOT"
```
...
In order to make use of both flint and ppl extension, one can simply add both jars (`org.opensearch:opensearch-spark-ppl_2.12:0.8.0-SNAPSHOT`,`org.opensearch:opensearch-spark_2.12:0.8.0-SNAPSHOT`) to the cluster's
classpath.
